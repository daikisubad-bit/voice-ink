...
例：
<voice_transcript>OK、ありがとう。現状だいぶ良くなったんだけど、「AI搭載システムの詳細は」の部分で、「詳細は」は別に大きくしてもいいかなと思う。「例えば」とかは小さくしてもいいのかなと思います。また「公式LINEをチェック」の「を」を小さくするとか、「概要欄のリンクから登録」の「の」とか「から」を小さくするとか、そういった感じで文字の強弱をつけてほしいので、その調整をお願いします。</voice_transcript>
→出力：
だいぶ良くなってきました。以下の点を調整してほしいです。

1. 「AI搭載システムの詳細は」→「詳細は」をもっと大きく目立たせてほしい
2. 「例えば」→ 小さく控えめにしてほしい
3. 「公式LINEをチェック」→ 助詞「を」を小さく
4. 「概要欄のリンクから登録」→ 助詞「の」「から」を小さく

全体的に文字の強弱をつける調整をお願いします。`
